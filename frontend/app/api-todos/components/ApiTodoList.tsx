        ...
        {tasks.length === 0 ? (
          ...
          tasks.map((task) => (
            <div
              ...
              className={`group flex items-start justify-between p-4 rounded-xl border
            ...
            >
              <div className="flex items-start sm:items-center gap-3.5 flex-1 pr-2">
                ...
                <div>
                  <p
                    className={`text-vs text-sm font-medium leading-relaxed transition-all ${task.completed
